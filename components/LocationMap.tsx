  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        draggable={false}
        className="absolute -top-10 -left-10 w-44 h-auto animate-cloud blur-[1px] select-none pointer-events-none z-10 transition-opacity duration-500"
        style={{ opacity: hovered ? 0 : 0.18 }}
      />
