  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        draggable={false}
        className={`absolute -top-10 -left-10 w-44 h-auto animate-cloud blur-[1px] opacity-[0.18] select-none pointer-events-none z-10 transition-opacity duration-500 ${hovered ? 'opacity-0' : 'opacity-100'}`}
      />
